...
account_CATEGORIES_TYPE_CHOICES = [
    ...
    ('ΟΔΟΙΠΟΡΙΚΑ ΕΞΩΤΕΡΙΚΟΥ','ΟΔΟΙΠΟΡΙΚΑ ΕΞΩΤΕΡΙΚΟΥ'),
    ...
    ('ΛΟΙΠΕΣ ΑΠΟΖΗΜΙΩΣΕΙΣ ΕΝΙΑΙΟΥ ΜΙΣΘΟΛΟΓΙΟΥ (ΜΟΝΙΜΩΝ-ΙΔΑΧ)','ΛΟΙΠΕΣ ΑΠΟΖΗΜΙΩΣΕΙΣ ΕΝΙΑΙΟΥ ΜΙΣΘΟΛΟΓΙΟΥ (ΜΟΝΙΜΩΝ ΙΔΑΧ)'),
    ('ΛΟΙΠΕΣ ΑΠΟΖΗΜΙΩΣΕΙΣ ΕΝΙΑΙΟΥ ΜΙΣΘΟΛΟΓΙΟΥ (ΙΔΟΧ)','ΛΟΙΠΕΣ ΑΠΟΖΗΜΙΩΣΕΙΣ ΕΝΙΑΙΟΥ ΜΙΣΘΟΛΟΓΙΟΥ (ΙΔΟΧ)'),
    ('ΔΙΚΑΣΤΙΚΑ','ΔΙΚΑΣΤΙΚΑ'),
    ('ΞΕΝΟΓΛΩΣΣΑ','ΞΕΝΟΓΛΩΣΣΑ'),
    ('ΕΞΟΔΑ ΔΙΑΝΥΚΤΕΡΕΥΣΗΣ','ΕΞΟΔΑ ΔΙΑΝΥΚΤΕΡΕΥΣΗΣ'),
    ('ΑΚΟΥΣΤΙΚΑ ΒΑΡΥΚΟΪΑΣ','ΑΚΟΥΣΤΙΚΑ ΒΑΡΥΚΟΪΑΣ'),
    ('ΔΗΜ.Ω.Σ. ΠΡΟΣΘΕΤΗ ΑΜΟΙΒΗ ΕΚΠ κ ΕΕΠ (ΜΟΝΙΜΟΙ-ΙΔΑΧ)','ΔΗΜ.Ω.Σ. ΠΡΟΣΘΕΤΗ ΑΜΟΙΒΗ ΕΚΠ κ ΕΕΠ (ΜΟΝΙΜΟΙ-ΙΔΑΧ)'),
    ('ΔΗΜ.Ω.Σ. ΠΡΟΣΘΕΤΗ ΑΜΟΙΒΗ ΕΚΠ κ ΕΕΠ (ΙΔΟΧ)','ΔΗΜ.Ω.Σ. ΠΡΟΣΘΕΤΗ ΑΜΟΙΒΗ ΕΚΠ κ ΕΕΠ (ΙΔΟΧ)'),
    ]
